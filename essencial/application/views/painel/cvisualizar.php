    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          ?>
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Colaboradores - Visualizar <?php  echo $linha->nome; ?></h1>
          <hr>
          <div class="form-group row">
                  ...
                  <br>
                  <br>
                  CPF: <?php  echo $linha->CPF; ?>
                  </div>
                  <div class="col-sm-4">
                  Sexo: <?php  echo $linha->sexo; ?>
                  <br>
                  <br>
                  Email: <?php  echo $linha->email; ?>
                  </div>
                  <div class="col-sm-4">
                  Data de Inserção: <?php  echo date("d/m/Y", strtotime($linha->data)); ?>
                  </div>
          </div>
          <?php 
          endforeach;
          ...
          <div class="form-group row">
                  <div class="col-sm-4">
                  <h1 class="h4 mb-4 text-gray-800">Empresa: </h1>
                  </div>
                  <div class="col-sm-2">
                  </div>
                   <div class="col-sm-2">
          ...
          <?php echo form_close();?>
          <?php if(isset($Empresa) && sizeof($Empresa) > 0):
            ?>
             <?php 
              if($msg = get_msg()):
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <td><center><a class="btn btn-info btn-circle btn-sm" href="<?php echo base_url('empresas/visualizar/'.$linha->id_empresa); ?>"><i class="fas fa-eye"></i></a></center></td>
                      ...
                      <td><center><a class="btn btn-danger btn-circle btn-sm" href="<?php echo base_url('empresas/excluir/'.$linha->id_empresa); ?>" data-toggle="modal" data-target="#excluirModal"><i class="fas fa-trash"></i></a></center></td>
                      </tr>
                      <div class="modal fade" id="excluirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body"><?php echo "Colaborador: ".$linha->nome ?><br></div>
            ...
            <center>
             <a class="btn btn-primary" href = "<?php echo base_url('colaboradores/listar/all') ?>">Listar</a>
          </center>
          </div>
           <?php
          else:
