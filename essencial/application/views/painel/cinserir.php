    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Colaborador - Inserir Colaborador</h1>
          <hr>
        </div>
        <!-- /.container-fluid -->
        <?php 
        ...
        ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="text-left">
                    ...
                    <?php
                    echo form_dropdown('sexo',$sexo,'Masculino',
                      array(
                        'class' => 'form-control form-control-user',
                      ));
                    ?>
                ...
                <div class="form-group">
                  <div class="col-sm-13">
                    ...
                    $nomes[$linha->id_empresa] = $linha->nome;
                    endforeach;        
                    echo form_label('Empresa:','Empresa'); 
                    ?>
                  </div>
                  <?php
                    echo form_dropdown('empresa',$nomes,'',
                      array(
                        'class' => 'form-control form-control-user',
                      ));
                    ?>
