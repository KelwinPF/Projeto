      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('empresas/listar'); ?>">Listar</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('colaboradores/listar'); ?>">Listar</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Configurações - Alterar Usuário</h1>
          <hr>
        </div>
        <!-- /.container-fluid -->
        <?php 
        ...
        ?>
                ...
                <div class="form-group">
                  <div class="col-sm-9">
                          ...
                          <div class="text-left">
                            <?php 
                    echo form_label('Novo Usuário: ','usuari'); 
                    ?>
                  </div>
                    <?php
                    echo form_input('usuario',set_value('usuario'),
                      array(
                ...
                <div class="form-group">
                  <div class="col-sm-9">
                             <div class="text-left">
                            <?php 
                    echo form_label('Confirme com a senha ','senha'); 
                    ?>
                  </div>
                    <?php
