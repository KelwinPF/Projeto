...
<head>
  ...
  <title>Cerberus - Configurações</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- /.container-fluid -->
        <center><img class="img-profile rounded-circle" src="<?php echo base_url ('assets/bootstrap/img/user.png');?>"></center>
        <br>
        <?php 
              echo form_open();
             ?>
              ...
              <div class="col-lg-7">
                <hr>
                 <div class="form-group">
                  <div class="col-sm-9">
                    <h4 class="h4 mb-4 text-gray-800 text-center">Usuário: <?php echo $User; ?></h4>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-9">
                    <h4 class="h5 mb-4 text-gray-800">Email: <?php echo $Email; ?></h4>
                  </div>
                </div>
                <hr>
                <div class="form-group row">
                  <div class="col-sm-6">
                    <a href="<?php echo base_url('painel/configuracoes'); ?>" class="btn btn-primary btn-user btn-block">
                      Alterar Email
                    </a>
                  </div>
                  <div class="col-sm-6">
                    <a href="<?php echo base_url('painel/userconfig'); ?>" class="btn btn-primary btn-user btn-block">
                      Alterar Usuário
                    </a>
                </div>
                <?php 
