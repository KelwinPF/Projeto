    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          ?>
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Empresas - Visualizar <?php  echo $linha->nome; ?></h1>
          <hr>
          <div class="form-group row">
                  <div class="col-sm-4">
                  Nome da Empresa: <?php  echo $linha->nome; ?>
                  <br>
                  <br>
                  CNPJ: <?php  echo $linha->cnpj; ?>
                  </div>
                  <div class="col-sm-4">
                  Email: <?php  echo $linha->email; ?>
                  <br>
                  <br>
                  Quantidade de Colaboradores: <?php  echo $Quantidade; ?>
                  </div>
                  <div class="col-sm-4">
          ...
          <div class="form-group row">
                  <div class="col-sm-4">
                  <h1 class="h4 mb-4 text-gray-800">Colaboradores: </h1>
                  </div>
                  <div class="col-sm-2">
                     <?php 
          ...
          <?php if(isset($Colaboradores) && sizeof($Colaboradores)>0):
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <td><center><a class="btn btn-danger btn-circle btn-sm" href="<?php echo base_url('colaboradores/excluir/'.$linha->id_colaborador); ?>" data-toggle="modal" data-target="#<?=$linha->nome; ?>excluirModal"><i class="fas fa-trash"></i></a></center></td>
                      </tr>
           ...
           ?>
           <center>
             <a class="btn btn-primary" href = "<?php echo base_url('empresas/listar/all') ?>">Listar</a>
          </center>
         </div>
