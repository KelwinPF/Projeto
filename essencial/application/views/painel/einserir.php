      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('colaboradores/listar'); ?>">Inserir</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Empresa - Inserir Empresa</h1>
          <hr>
        </div>
        <!-- /.container-fluid -->
        <?php 
        ...
        ?>
                 <div class="form-group">
                  <div class="col-sm-9">
                      <div class="text-left">
                            <?php 
                    echo form_label('Nome da Empresa: ','nome'); 
                    ?>
                  </div>
                    <?php   
                ...
                <div class="form-group">
                  <div class="col-sm-9">
                         <div class="text-left">
                            <?php 
                    echo form_label('Email da Empresa: ','email'); 
                    ?>
                  </div>
                    <?php  
                ...
                <div class="form-group">
                  <div class="col-sm-9">
                    <div class="text-left">
                            <?php 
                    echo form_label('CNPJ da Empresa:','cnpj'); 
                    ?>
                  </div>
                    <?php
                    echo form_input('cnpj',set_value('cnpj'),
                      array(
                        'class' => 'form-control form-control-user',
                ...
                <br>
                 <div class="form-group row">
                  <div class="col-sm-6">
                    <a href="<?php echo base_url ('empresas/listar/all') ?>" class="btn btn-primary btn-user btn-block">
                    Voltar
                    </a>
                  </div>
                  <div class="col-sm-6">
                     <?php 
                    echo form_submit('envia','Inserir',
                      array(
