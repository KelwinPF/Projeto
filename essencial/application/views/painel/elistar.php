    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Empresas - Listagem de Empresas</h1>
          <hr>
          <?php
          echo form_open();
          ?>
          <div class="form-group row">
                  <div class="col-sm-2">
                    <a href="<?php echo base_url('empresas/inserir'); ?>" class="btn btn-primary btn-user btn-block">
                      Nova Empresa
                    </a>
                  </div>
                  <div class="col-sm-2">
              ...
              ?>
          <?php if(isset($Empresas) && sizeof($Empresas)>0):
            ?>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <td><center><a class="btn btn-info btn-circle btn-sm" href="<?php echo base_url('empresas/visualizar/'.$linha->id_empresa.'/all'); ?>"><i class="fas fa-eye"></i></a></center></td>
                      <td><center><a class="btn btn-warning btn-circle btn-sm" href="<?php echo base_url('empresas/editar/'.$linha->id_empresa); ?>"><i class="fas fa-pen"></i></a></center></td>
                      <div class="modal fade" id="<?=$linha->nome; ?>excluirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body"><?php echo "Empresa: ".$linha->nome ?><br>*Colaboradores que pertencem a esta empresa também serão deletados!</div>
                            <div class="modal-footer">
                              <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                              <a class="btn btn-primary" href = "<?php echo base_url('empresas/excluir/'.$linha->id_empresa); ?>">Excluir</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <td><center><a class="btn btn-danger btn-circle btn-sm" href="<?php echo base_url('empresas/excluir/'.$linha->id_empresa); ?>" data-toggle="modal" data-target="#<?=$linha->nome; ?>excluirModal"><i class="fas fa-trash"></i></a></center></td>
                      </tr>
                         <?php 
                    endforeach;
                    ?>
