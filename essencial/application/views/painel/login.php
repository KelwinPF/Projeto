  ...
  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block"><img src="<?php echo base_url ('assets/bootstrap/img/cerberus.jpg'); ?>" alt="Cerberus" width=495 height=545></div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="<?php echo base_url ('login/login') ?>">Já possui conta? Login!</a>
              </div>
            </div>
          </div>
        </div>
